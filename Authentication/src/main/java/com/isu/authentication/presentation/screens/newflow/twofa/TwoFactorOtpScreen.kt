package com.isu.authentication.presentation.screens.newflow.twofa
...
@Composable
fun TwoFactorOtpScreen(
    modifier: Modifier = Modifier,
    state: RegistrationState,
    onEvent: (CommonScreenEvents) -> Unit,
) {
    val otp = state.twoFAOTP
    val otpErr = state.twoFAOTPError
    val otpErrMsg = state.twoFAOTPErrorMessage
                    ...
                    Column(
                            ...
                            onValueChange = {
                                onEvent(
                                    CommonScreenEvents.OnTextChanged(
                                        type = RegistrationInputField.TwoFAOtpField,
                                        text = it
                                    )
                                )
                            },
                        ...
                        CustomButton(
                            onClick = {
                                ...
                                scope.launch {
                                    onEvent(CommonScreenEvents.OnClick<Any>(type = RegistrationButtonType.TwoFAOtpVerificationButton))
                        ...
                        CustomText(
                            ...
                            modifier = Modifier
                                ...
                                .clickable(enabled = timer.intValue == 0) {
                                    onEvent(CommonScreenEvents.OnClick<Any>(type = RegistrationButtonType.ResendTwoFAOTP))
