...
@Composable
fun LinkCardOtpScreen(
    state: LinkCardUiState = LinkCardUiState(),
    onEvent: (CommonScreenEvents) -> Unit = {},
    modifier: Modifier = Modifier,
    linkCardViewModel: LinkCardViewModel,
) {
    val otp = linkCardViewModel.otp
    val otpErr = state.otpError
    val otpErrMsg = state.otpErrorMessage
                            ...
                            onValueChange = {
                                ...
                                onEvent(
                                    CommonScreenEvents.OnTextChanged(
                                        type = LinkCardTextFieldType.OtpField,
                                        text = it
                                    )
                                )
                            },
                        ...
                        CustomButton(
                            onClick = {
                                ...
                                scope.launch {
                                    ...
                                    onEvent(CommonScreenEvents.OnClick<Any>(type = LinkCardButtonType.OtpVerificationButton))
//
