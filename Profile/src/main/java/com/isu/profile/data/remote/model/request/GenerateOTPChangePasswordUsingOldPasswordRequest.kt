...
/**
 * @author- karthik
 * Data class representing a request to generate an OTP for changing a password using the old password.
 *
 * @property newPassword The new password to be set.
 * @property oldPassword The current/old password.
 */
@Keep
data class GenerateOTPChangePasswordUsingOldPasswordRequest(
